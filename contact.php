...
<body>
  ...
  <section id="hero" class="hero d-flex align-items-center section-bg otherrr" style="background-image: linear-gradient(rgba(0, 0, 0, 0.2),rgba(1, 6, 7, 0.446)),url(./assets/img/lop.jpg) ;">
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up" class="oth-fonts">CONTACT</h2>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
           
          </div>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <!-- <img src="assets/img/abt.jpg" class="img-fluid" alt="Main Image" data-aos="zoom-out" data-aos-delay="300"> -->
        </div>
      </div>
    </div>
